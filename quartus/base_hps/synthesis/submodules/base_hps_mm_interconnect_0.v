...
module base_hps_mm_interconnect_0 (
	...
	wire   [29:0] adc_0_adc_slave_agent_m0_address;                    // adc_0_adc_slave_agent:m0_address -> adc_0_adc_slave_translator:uav_address
	...
	wire  [121:0] adc_0_adc_slave_agent_rf_source_data;                // adc_0_adc_slave_agent:rf_source_data -> adc_0_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [121:0] adc_0_adc_slave_agent_rsp_fifo_out_data;             // adc_0_adc_slave_agent_rsp_fifo:out_data -> adc_0_adc_slave_agent:rf_sink_data
	...
	wire  [120:0] adc_0_adc_slave_agent_rp_data;                       // adc_0_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [120:0] cmd_mux_src_data;                                    // cmd_mux:src_data -> adc_0_adc_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                   // adc_0_adc_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                 // cmd_mux:src_channel -> adc_0_adc_slave_burst_adapter:sink0_channel
	...
	wire  [120:0] adc_0_adc_slave_burst_adapter_source0_data;          // adc_0_adc_slave_burst_adapter:source0_data -> adc_0_adc_slave_agent:cp_data
	...
	wire    [1:0] adc_0_adc_slave_burst_adapter_source0_channel;       // adc_0_adc_slave_burst_adapter:source0_channel -> adc_0_adc_slave_agent:cp_channel
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~adc_0_reset_reset_bridge_in_reset_reset),          //        clk_reset.reset_n
