	base_hps u0 (
		...
		.motor_left_external_connection_export  (<connected-to-motor_left_external_connection_export>),  //  motor_left_external_connection.export
		.motor_right_external_connection_export (<connected-to-motor_right_external_connection_export>), // motor_right_external_connection.export
		.pb_pio_external_connection_export      (<connected-to-pb_pio_external_connection_export>),      //      pb_pio_external_connection.export
		.pll_adc_clk_locked_export              (<connected-to-pll_adc_clk_locked_export>),              //              pll_adc_clk_locked.export
		.pll_adc_clk_outclk1_clk                (<connected-to-pll_adc_clk_outclk1_clk>),                //             pll_adc_clk_outclk1.clk
		.sonar_0_external_connection_export     (<connected-to-sonar_0_external_connection_export>),     //     sonar_0_external_connection.export
		.sw_pio_external_connection_export      (<connected-to-sw_pio_external_connection_export>),      //      sw_pio_external_connection.export
		.sonar_1_external_connection_export     (<connected-to-sonar_1_external_connection_export>)      //     sonar_1_external_connection.export
	);
