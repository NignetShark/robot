...
module base_hps_mm_interconnect_0 (
	...
	wire  [116:0] pb_pio_s1_agent_rf_source_data;                           // pb_pio_s1_agent:rf_source_data -> pb_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] pb_pio_s1_agent_rsp_fifo_out_data;                        // pb_pio_s1_agent_rsp_fifo:out_data -> pb_pio_s1_agent:rf_sink_data
	...
	wire  [116:0] motor_left_s1_agent_rf_source_data;                       // motor_left_s1_agent:rf_source_data -> motor_left_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] motor_left_s1_agent_rsp_fifo_out_data;                    // motor_left_s1_agent_rsp_fifo:out_data -> motor_left_s1_agent:rf_sink_data
	...
	wire  [116:0] motor_right_s1_agent_rf_source_data;                      // motor_right_s1_agent:rf_source_data -> motor_right_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] motor_right_s1_agent_rsp_fifo_out_data;                   // motor_right_s1_agent_rsp_fifo:out_data -> motor_right_s1_agent:rf_sink_data
	...
	wire  [115:0] sysid_control_slave_agent_rp_data;                        // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] led_pio_s1_agent_rp_data;                                 // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] pb_pio_s1_agent_rp_data;                                  // pb_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] sw_pio_s1_agent_rp_data;                                  // sw_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] motor_left_s1_agent_rp_data;                              // motor_left_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] motor_right_s1_agent_rp_data;                             // motor_right_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> sysid_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // sysid_control_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> sysid_control_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] sysid_control_slave_burst_adapter_source0_data;           // sysid_control_slave_burst_adapter:source0_data -> sysid_control_slave_agent:cp_data
	...
	wire    [5:0] sysid_control_slave_burst_adapter_source0_channel;        // sysid_control_slave_burst_adapter:source0_channel -> sysid_control_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> pb_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // pb_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> pb_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] pb_pio_s1_burst_adapter_source0_data;                     // pb_pio_s1_burst_adapter:source0_data -> pb_pio_s1_agent:cp_data
	wire          pb_pio_s1_burst_adapter_source0_ready;                    // pb_pio_s1_agent:cp_ready -> pb_pio_s1_burst_adapter:source0_ready
	wire    [5:0] pb_pio_s1_burst_adapter_source0_channel;                  // pb_pio_s1_burst_adapter:source0_channel -> pb_pio_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> sw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // sw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> sw_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_004_src_data;                                     // cmd_mux_004:src_data -> motor_left_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                    // motor_left_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                  // cmd_mux_004:src_channel -> motor_left_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] motor_left_s1_burst_adapter_source0_data;                 // motor_left_s1_burst_adapter:source0_data -> motor_left_s1_agent:cp_data
	wire          motor_left_s1_burst_adapter_source0_ready;                // motor_left_s1_agent:cp_ready -> motor_left_s1_burst_adapter:source0_ready
	wire    [5:0] motor_left_s1_burst_adapter_source0_channel;              // motor_left_s1_burst_adapter:source0_channel -> motor_left_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                     // cmd_mux_005:src_data -> motor_right_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                    // motor_right_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                  // cmd_mux_005:src_channel -> motor_right_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] motor_right_s1_burst_adapter_source0_data;                // motor_right_s1_burst_adapter:source0_data -> motor_right_s1_agent:cp_data
	wire          motor_right_s1_burst_adapter_source0_ready;               // motor_right_s1_agent:cp_ready -> motor_right_s1_burst_adapter:source0_ready
	wire    [5:0] motor_right_s1_burst_adapter_source0_channel;             // motor_right_s1_burst_adapter:source0_channel -> motor_right_s1_agent:cp_channel
	...
	base_hps_mm_interconnect_0_router_002 router_004 (
	...
	base_hps_mm_interconnect_0_router_002 router_005 (
	...
	base_hps_mm_interconnect_0_router_002 router_006 (
	...
	base_hps_mm_interconnect_0_router_002 router_007 (
	...
	base_hps_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (motor_left_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (motor_left_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (motor_left_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_hps_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (motor_left_reset_reset_bridge_in_reset_reset), // clk_reset.reset
