...
module base_hps_hps_0 #(
		...
		output wire        spim1_txd,                //                    spim1.txd
		input  wire        spim1_rxd,                //                         .rxd
		input  wire        spim1_ss_in_n,            //                         .ss_in_n
		output wire        spim1_ssi_oe_n,           //                         .ssi_oe_n
		output wire        spim1_ss_0_n,             //                         .ss_0_n
		output wire        spim1_ss_1_n,             //                         .ss_1_n
		output wire        spim1_ss_2_n,             //                         .ss_2_n
		output wire        spim1_ss_3_n,             //                         .ss_3_n
		...
		input  wire        can0_rxd,                 //                     can0.rxd
		output wire        can0_txd,                 //                         .txd
	...
	base_hps_hps_0_fpga_interfaces fpga_interfaces (
		...
		.spim1_txd             (spim1_txd),             //                    spim1.txd
		.spim1_rxd             (spim1_rxd),             //                         .rxd
		.spim1_ss_in_n         (spim1_ss_in_n),         //                         .ss_in_n
		.spim1_ssi_oe_n        (spim1_ssi_oe_n),        //                         .ssi_oe_n
		.spim1_ss_0_n          (spim1_ss_0_n),          //                         .ss_0_n
		.spim1_ss_1_n          (spim1_ss_1_n),          //                         .ss_1_n
		.spim1_ss_2_n          (spim1_ss_2_n),          //                         .ss_2_n
		.spim1_ss_3_n          (spim1_ss_3_n),          //                         .ss_3_n
		...
		.can0_rxd              (can0_rxd),              //                     can0.rxd
		.can0_txd              (can0_txd)               //                         .txd
	);
